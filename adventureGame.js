...
// Showing Names
console.log(`${chalk.green.bold.italic(p1.name)} VS ${chalk.red.bold.italic(o1.name)}`);
// Showing Fuels
console.log(`${chalk.blueBright.bold("Player Health:")} ${chalk.green(p1.fuel)} ${chalk.redBright.bold("Opponent Health:")} ${chalk.red(o1.fuel)}`);
async function game() {
    do {
        if (opponent.select == "skeleton") {
            ...
            if (choice.player == "Attack") {
                ...
                if (num == 0) {
                    o1.fuelDecrease();
                    console.log(`Player Health: ${chalk.green(p1.fuel)} Opponent Health: ${chalk.red(o1.fuel)}`);
                    if (o1.fuel <= 0) {
